...
const groups: QuestionGroup[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Si por cualquier motivo decidís no continuar en la plataforma o querés dejar de recibir nuestras comunicaciones, podés solicitar la baja definitiva de tu cuenta y la supresión de tus datos en cualquier momento. Solo tenés que enviarnos un mensaje formal completando el formulario de “Contacto” disponible en el sitio web. La baja de los datos implicará la cancelación inmediata de la visibilidad de tu perfil.",
      },
      {
