...
import { z } from "zod";
import { paypalEnvFields } from "./paypal";
...
export const serverEnv = serverEnvSchema.parse({
  ...
  PAYPAL_ENV: process.env.PAYPAL_ENV || undefined,
  PAYPAL_LIVE_CHECKOUT_ENABLED: process.env.PAYPAL_LIVE_CHECKOUT_ENABLED || undefined,
  PAYPAL_SANDBOX_CLIENT_ID: process.env.PAYPAL_SANDBOX_CLIENT_ID || undefined,
  PAYPAL_SANDBOX_CLIENT_SECRET: process.env.PAYPAL_SANDBOX_CLIENT_SECRET || undefined,
  PAYPAL_SANDBOX_WEBHOOK_ID: process.env.PAYPAL_SANDBOX_WEBHOOK_ID || undefined,
  PAYPAL_SANDBOX_PLANS: process.env.PAYPAL_SANDBOX_PLANS || undefined,
  PAYPAL_LIVE_CLIENT_ID: process.env.PAYPAL_LIVE_CLIENT_ID || undefined,
  PAYPAL_LIVE_CLIENT_SECRET: process.env.PAYPAL_LIVE_CLIENT_SECRET || undefined,
  PAYPAL_LIVE_WEBHOOK_ID: process.env.PAYPAL_LIVE_WEBHOOK_ID || undefined,
  PAYPAL_LIVE_PLANS: process.env.PAYPAL_LIVE_PLANS || undefined,
