    ...
    <section className="bg-paper py-16 sm:py-24">
      <Container className="max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-base leading-8 text-muted">
          ...
          <section><h2 className="text-xl font-semibold text-ink">Conservación y derechos</h2><p className="mt-2">Conservamos cada dato sólo durante el tiempo necesario para su finalidad, obligaciones legales, prevención de fraude y resolución de disputas. Podés solicitar acceso, corrección o eliminación escribiendo a <a className="font-semibold underline underline-offset-4" href="mailto:hola@universosenda.com">hola@universosenda.com</a>. No envíes contraseñas ni documentación clínica por correo.</p></section>
