...
### Investigación y registro de marca — 21/09/2026

Archivo persistente: [índice de marca](research/README.md), [investigación de registrabilidad](research/registrabilidad-universopsi-argentina-2026-09-21.md) y [guía ABC para presentación personal](research/guia-abc-registro-universopsi-2026-09-21.md). Incluye 401 antecedentes exportados y evidencia TMview. No se acredita disponibilidad: falta búsqueda fonética/revisión nacional y decidir tipo y servicios. El usuario confirmó que será titular único como persona humana (100%) y planea realizar el trámite el 22/09/2026. Sus datos legales se completarán en el portal. No se presentó ni pagó solicitud. No confundir esta investigación con habilitación fiscal o sanitaria. Revalidar requisitos y aranceles al presentar.
...
- **Implementado — públicas:** `/`, `/profesionales`, `/profesionales/[slug]`, `/para-profesionales`, `/planes`, `/convenios`, `/convenios/[slug]`, `/recursos`, `/recursos/[slug]`, `/preguntas-frecuentes`, `/contacto`, `/terminos` y `/privacidad`.
