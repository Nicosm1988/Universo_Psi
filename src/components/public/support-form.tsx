    ...
    return (
      <div role="status" className="rounded-[1.25rem] border border-senda/25 bg-senda-soft p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted">
          Queda registrado con fecha de servidor. Te respondemos al correo que indicaste. Si tu pedido es de
          acceso, rectificación o supresión de datos, los plazos de la Ley N° 25.326 se cuentan desde esta
          recepción.
        </p>
