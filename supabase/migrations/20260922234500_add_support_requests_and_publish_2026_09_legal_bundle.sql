...
--
-- La política de privacidad remite a este canal para ejercer los derechos de
-- acceso, rectificación, actualización y supresión de la Ley N° 25.326, para
-- pedir la baja y para reportar contenidos. Por eso el pedido se persiste antes
-- de cualquier aviso por correo: el plazo legal corre desde la recepción y no
-- puede depender de que el proveedor de email esté configurado.
--
...
create table private.support_requests (
  ...
  topic text not null check (
    topic in ('PRIVACIDAD', 'BAJA', 'REPORTE', 'SOPORTE', 'COMERCIAL', 'OTRO')
  ),
...
insert into private.legal_document_versions (
  ...
  (
    ...
    'a89c82c4988207d65a406daaaa039a1b105bf49b4fab103b8500edd0d16105ac',
    true, timestamptz '2026-09-22 00:00:00+00'
  ),
  (
    'PRIVACY', '2026-09', '/privacidad',
    '992b89d263ccb3f07b4dfbca9fccb4e6a984fc532b9fb7a63b7471ed0119fab0',
    true, timestamptz '2026-09-22 00:00:00+00'
  )
