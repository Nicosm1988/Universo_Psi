      ...
      <Container className="max-w-5xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-[0.9375rem] leading-7 text-muted">
            Este es el canal oficial que la{" "}
            <Link className="font-semibold text-ink underline underline-offset-4" href="/privacidad">
              política de privacidad
            </Link>{" "}
            indica para ejercer tus derechos de acceso, rectificación, actualización y supresión de datos, para
            pedir la baja de tu cuenta o de tu plan, y para reportar un perfil o un contenido.
          </p>
        </div>
